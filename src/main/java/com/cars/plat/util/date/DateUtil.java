package com.cars.plat.util.date;
...
public class DateUtil {
    ...
    private static final String defaultShortTimeFormatStr = "HH:mm:ss";//系统默认的格式化字符串
     ...
     * @date 2017-05-23
     */
    public static String getSystemShortTime() {
        String strTime = "";
        DateFormat df = new SimpleDateFormat(defaultShortTimeFormatStr);
    ...
    public static void main(String[] args) {
        System.out.println(DateUtil.getFirstDayOfMonth("2017-09-21"));
    }
